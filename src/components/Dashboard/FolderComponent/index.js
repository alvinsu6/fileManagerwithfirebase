...
const FolderComponent = () => {
  ...
  if (isLoading) {
    return (
      <Row>
        <Col md="12">
          <h1 className="text-center my-5">Waitt.....</h1>
        </Col>
      </Row>
    );
  }
  ...
  return (
    //merubah component dalam folder
    <>
      ...
      {userFolders && userFolders.length > 0 && (
        <>
          ...
          >
            {!folders ? (
              <h1 className="text-center">Menunggu Files....</h1>
            ) : (
      ...
      {createdFiles && createdFiles.length > 0 && (
        <>
          <p className="text-center border-bottom py-2">Created Filess</p>
          <Row
            md="2"
            style={{ height: "auto" }}
            className="pt-2  gap-2 pb-4 px-5"
      ...
      {uploadedFiles && uploadedFiles.length > 0 && (
        <>
          <p className="text-center border-bottom py-2">Uploaded Filesss</p>
          <Row
            md="2"
            style={{ height: "auto" }}
            className="pt-2  gap-2 pb-4 px-5"
